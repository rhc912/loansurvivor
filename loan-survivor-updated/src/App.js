...
const App = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-100 to-white min-h-screen font-sans max-w-screen-md mx-auto px-4">
      ...
      <section className="bg-white p-6 rounded-2xl shadow-lg border border-green-100 mb-8">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select name="loanType" value={borrowerData.loanType} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
          ...
          <div>
            ...
            <select name="occupancy" value={borrowerData.occupancy} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
          ...
          <div>
            ...
            <select name="propertyType" value={borrowerData.propertyType} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
          ...
          <div>
            ...
            <input name="downPayment" value={borrowerData.downPayment} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
          </div>

          <div>
            <label className="block mb-1 font-medium text-gray-700">Credit Score</label>
            <input name="creditScore" type="number" value={borrowerData.creditScore} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
          </div>
        </form>
      </section>
